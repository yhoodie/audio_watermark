...
| Endpoint | `POST http://app-dyjft4hsvfgh-api-rY7JzDpZVBQL-gateway.appmiaoda.com/v1/images/edits` |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "http://app-dyjft4hsvfgh-api-rY7JzDpZVBQL-gateway.appmiaoda.com/v1/images/edits",
    {
      method: "POST",
      headers: {
